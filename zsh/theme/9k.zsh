...
zsh_internet_signal(){
  ...
  local signal=$(/System/Library/PrivateFrameworks/Apple80211.framework/Versions/Current/Resources/airport  -I | grep agrCtlRSSI | awk '{print $2}' | sed 's/-//g')
  local noise=$(/System/Library/PrivateFrameworks/Apple80211.framework/Versions/Current/Resources/airport  -I | grep agrCtlNoise | awk '{print $2}' | sed 's/-//g')
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status laravel_version node_version background_jobs ram battery ip)
